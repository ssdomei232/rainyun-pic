...
<body class="mdui-appbar-with-toolbar  mdui-theme-primary-<?php echo $themeColor ?> mdui-theme-accent-<?php echo $accentColor; ?>">
  <div class="mdui-appbar mdui-appbar-fixed mdui-appbar-scroll-hide">
    <div class="mdui-toolbar mdui-color-<?php echo $themeColor ?>">
      ...
      <a href="javascript:;" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white search-trigger" mdui-tooltip="{content: '搜索梗图'}"><i class="mdui-icon material-icons">search</i></a>
    ...
    <div class="mdui-textfield search-box mdui-hidden" id="search-box">
        <form onsubmit="submitSearch(event)">
            ...
            <button class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" type="submit" mdui-tooltip="{content: '搜索'}">
